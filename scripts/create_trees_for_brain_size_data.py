...
# ensembl_df = pd.read_csv("../data/species_id_gene_id.tsv.gz", compression="gzip", header=0, delimiter="\t")
# ensembl_df.columns = ["Binomial", "ensembl_id"]
...
species_id = pd.read_csv("../data/species_id_gene_id.tsv.gz", compression="gzip",header=None, index_col=1, delimiter="\t")
species_id.columns = ["species", "gene_id", "gene"]
species_id.index.name = "species_id"
