...
ensembl_df = pd.read_csv("../data/species_id_gene_id.tsv", header=0, delimiter="\t")
...
species_id = pd.read_csv("../data/species_id_gene_id.tsv", header=None, index_col=1, delimiter="\t")
